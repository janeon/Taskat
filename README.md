...
1. Be able to add tabs from menu / welcome page
2. Persist states from each tab to the current task via the registerFinalStateFunc
3. Integrate information across multiple tabs
